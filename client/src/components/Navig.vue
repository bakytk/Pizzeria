    ...
    <b-navbar toggleable="lg" type="light" variant="light">
		...
		<b-navbar-nav align="center" v-if="LARGE">
			<b-nav-item :href="'/#' + 'menu'">
				<b-button variant="danger"> View menu </b-button>
			</b-nav-item>
		</b-navbar-nav>
		...
		<b-navbar-toggle target="nav-collapse"></b-navbar-toggle>
			...
			<b-navbar-nav class="ml-auto">
				...
				<b-nav-item>
					...
					<a  @click="showCart" > Cart ({{ cartLen  }}) </a>
					<b-modal ref="kart" size="md" hide-footer>
						 <cart @exitmd="hideCart"></cart>
  					</b-modal>
					<b-modal ref="lid" size="md" title="Make order" hide-footer>
						 <lead></lead>
  					</b-modal>
				</b-nav-item>
				...
				<b-collapse id="nav-collapse" is-nav>
    				<b-nav-item-dropdown text="Admin" right>
          				...
          				<b-dropdown-item @click="showLog">Login</b-dropdown-item>
						<b-modal ref="login" size="md" title="Login" hide-footer>
							<log></log>
  						</b-modal>

						<b-dropdown-item @click="showReg">Register</b-dropdown-item>
						<b-modal ref="registr" size="md" title="Register" hide-footer>
							<reg></reg>
  						</b-modal>

          				<b-dropdown-item @click="showRestore">Restore</b-dropdown-item>
						<b-modal ref="restore" size="md" title="Restore account" hide-footer>
							<restore></restore>
  						</b-modal>
